...
Revision ID: 56042b3ea800
Revises: 
Create Date: 2022-05-09 05:20:47.288721
...
def upgrade():
    ...
    sa.Column('pitch_author', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['pitch_author'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
